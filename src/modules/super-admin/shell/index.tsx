...
import { SidebarNav, TabNav } from "@/modules/admin/shell/nav";

const logoutIcon = (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
    <path d="M7 15.25H4a1.25 1.25 0 0 1-1.25-1.25V4A1.25 1.25 0 0 1 4 2.75h3" strokeLinecap="round" />
    <path d="M11.5 12.5 15 9l-3.5-3.5M15 9H6.75" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
  ...
  return (
    <div className="min-h-svh bg-[#080b1c] text-white lg:flex">
      <aside className="sticky top-0 hidden h-svh w-64 shrink-0 flex-col border-r border-white/[0.06] bg-[#0b0e22] lg:flex">
        ...
        <nav aria-label="Dashboard" className="flex-1 overflow-y-auto px-4 pt-6">
