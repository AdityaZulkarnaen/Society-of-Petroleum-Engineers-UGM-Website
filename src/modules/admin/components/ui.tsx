...
/* Compact card ("ACard" in Figma), used for every super admin container.
     Fill   — linear #FFFFFF 6% → 0% at 50%. The Figma handle runs mostly
              left to right (about 109° on the 552 × 159 Divisi card), so a
              fixed angle; 'to bottom right' would run almost top to bottom
              on wide cards.
     Fill   — #FFFFFF 3%
...
export const compactCardSurface =
  ...
  "bg-[linear-gradient(109deg,rgb(255_255_255/0.06)_0%,rgb(255_255_255/0)_50%),linear-gradient(rgb(255_255_255/0.03),rgb(255_255_255/0.03))] " +
...
export function Stat({
  ...
  return (
    <Card surface={surface} className="px-6 py-6">
      <Label>{label}</Label>
